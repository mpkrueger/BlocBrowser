...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    if ([URLString rangeOfString:@" "].location != NSNotFound) {
        NSArray *separateWords = [URLString componentsSeparatedByString:@" "];
        NSString *newString = [separateWords componentsJoinedByString:@"+"];
        NSLog(@"%@", newString);
        URL = [NSURL URLWithString:[NSString stringWithFormat:@"http://www.google.com/search?q=%@", newString]];
        NSLog(@"%@", URL);
    }
